...
rects = [Rect(xmin=-0.7,xmax=3,ymin=-3.3,ymax=0),
         Rect(xmin=-12,xmax=-5.7,ymin=-4.7,ymax=0.7),
         Rect(xmin=-11.2,xmax=-3.9,ymin=-6.5,ymax=-4.4),
         Rect(xmin=-10.9,xmax=-7.9,ymin=-8.6,ymax=-6.5)]
...
pcd_path = '../../../scratch/btuncay/cog/gnn_spatial_reasoning/datasets/test_terrace/terrace/scan_raw/combined_aligned.ply'
...
for vantage_idx, point in enumerate(zip(path,dirs)):
    ...
    out_path = f'../../../scratch/btuncay/cog/gnn_spatial_reasoning/datasets/processed/test_terrace/random_walks/rw_{process_idx}_{vantage_idx}.pt'
    point, viewdir = point
    vantage = np.array([point[0], point[1], -3.4], dtype=np.float32)
