...
pcd_path = '../../../scratch/btuncay/cog/gnn_spatial_reasoning/datasets/pipes/pipes/scan_raw/scan1.ply'
...
for vantage_idx, point in enumerate(zip(path,dirs)):
    ...
    out_path = f'../../../scratch/btuncay/cog/gnn_spatial_reasoning/datasets/processed/pipes/random_walks/rw_{process_idx}_{vantage_idx}.pt'
    point, viewdir = point
