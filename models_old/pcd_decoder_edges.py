...
class PCDDecoder(nn.Module):
    ...
    #TODO: instead of predicting edge weights, calculate at each prediction
    def forward(self, z: torch.Tensor):
        ...
        for b in range(B):
            x = x_b[b]
            edge_index = self.decode_edges_from_candidates(x)
            ...
            graphs.append(
                Data(
                    ...
                    edge_weight=edge_weight,   # for GCNConv-style APIs
