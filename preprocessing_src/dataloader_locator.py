## Dataloader for the locator model
# This file contains the PyTorch dataloader for the
# locator model. It takes in global point clouds
# or view point clouds generated with the VAE,
# and feeds them onto the locator model.
