...
# encoder: img -> aligned vector

LATENT_DIM = 128
TRAIN_BATCH_SIZE = 2
PARTIAL_SEQUENCE_LENGTH = 30
LEARNING_RATE = 2e-5
WEIGHT_DECAY = 1e-6
CLIP_GRAD_NORM = 1.0
...
ALIAS = "0521_gnn_k2_l1_d128_encoder_img"
EPOCHS = 40000
...
def trajectory_loss_terms(
    ...
    trajectory_loss = torch.sqrt(F.mse_loss(pred_locs[finite], target_locs[finite]))
